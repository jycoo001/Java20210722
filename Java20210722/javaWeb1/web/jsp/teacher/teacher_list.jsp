...
<%@ page import="com.jyc.javaWeb.entity.Teacher" %><%--
...
<body>
    <a class="btn btn-success" href="${pageContext.request.contextPath}/teacher_insert.jsp?pageSize=${pageInfo.pageSize}">添加</a>
    <a class="btn btn-success" href="${pageContext.request.contextPath}/teacher">返回首页</a>
    <hr/>
        ...
        <c:forEach items="${pageInfo.list}" var="teacher">
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/teacher?method=selectOne&id=${teacher.id}&pageNumber=${pageInfo.pageNumber}">修改</a>
                </td>
            </tr>
        </c:forEach>
    </table>
    ...
    <script type="text/javascript">
            function deleteById (id) {
                ...
                if (isDelete) {
                location.href = "${pageContext.request.contextPath}/teacher?method=deleteById&id=" + id + "&pageNumber="+${pageInfo.pageNumber};
                }
            }
    </script>
</body>
