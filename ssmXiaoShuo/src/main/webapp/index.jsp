	...
	<div id="wrapper">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						...
						<div class="logo-element">永晨</div>
					</li>
					<li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
						<span class="ng-scope">管理员功能菜单</span>
					</li>
					<li><a class="J_menuItem" href="Admin/index"> <i
							class="fa fa-home"></i> <span class="nav-label">管理员员管理</span>
					</a></li>
					<li><a class="J_menuItem" href="Writer/index"> <i
							class="fa fa-home"></i> <span class="nav-label">作者管理</span>
					</a></li>
					<li><a class="J_menuItem" href="Reader/index"> <i
							class="fa fa-home"></i> <span class="nav-label">读者管理</span>
					</a></li>
					<li><a class="J_menuItem" href="Library/index"> <i
							class="fa fa-home"></i> <span class="nav-label">图书管理</span>
					</a></li>
					<li><a class="J_menuItem" href="See/index"> <i
							class="fa fa-home"></i> <span class="nav-label">游客管理</span>
					</a></li>
					<li><a class="J_menuItem" href="javascript:;"
						onclick="openpass();"> <i class="fa fa-home"></i> <span
							class="nav-label">修改密码</span>
					</a></li>
					<li><a class="J_menuItem" href="Admin/outlogin"> <i
							class="fa fa-home"></i> <span class="nav-label">退出系统</span>
					</a></li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe id="J_iframe" width="100%" height="100%" src="blank.html"
